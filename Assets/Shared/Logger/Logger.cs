...
using UnityEngine;
public class Logger{
     public static void Infof( string Format, params object[] Parameters ){
        var content = Formator.sprintf(Format,Parameters);
        Debug.unityLogger.Log(LogType.Log, content);
    }
    public static void Debugf( string Format, params object[] Parameters ){
        var content = Formator.sprintf(Format,Parameters);
        Debug.Log(content);
    }
    public static void Warnf( string Format, params object[] Parameters ){
        var content = Formator.sprintf(Format,Parameters);
        Debug.LogWarning(content);
    }
    public static void Errorf( string Format, params object[] Parameters ){
        var content = Formator.sprintf(Format,Parameters);
...
public class Formator{
    #region Public Methods
        ...
        {
            Console.Write( Formator.sprintf( Format, Parameters ) );
        }
        #endregion
        #region fprintf
        public static void fprintf( TextWriter Destination, string Format, params object[] Parameters )
        {
            Destination.Write( Formator.sprintf( Format, Parameters ) );
        }
        #endregion
        #region sprintf
